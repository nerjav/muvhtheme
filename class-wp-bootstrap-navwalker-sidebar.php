 ...
 *
 * @wordpress-plugin
 * Plugin Name: WP Bootstrap Navwalker Sidebar
...
if (! class_exists('WP_Bootstrap_Navwalker_Sidebar')) :
    /**
     * WP_Bootstrap_Navwalker_Sidebar class.
     */
    class WP_Bootstrap_Navwalker_Sidebar extends Walker_Nav_Menu
    {
        ...
        public function start_lvl(&$output, $depth = 0, $args = null)
        {
            ...
            /*
             * The `.list-unstyled` container needs to have a labelledby
            ...
            if (end($matches[2])) {
                ...
                $id = 'id="' . esc_attr(end($matches[2])) . '-submenu"';
            }

            $output .= "{$n}{$indent}<ul$class_names $labelledby $id>{$n}";
        }
        ...
        public function start_el(&$output, $item, $depth = 0, $args = null, $id = 0)
        {
            ...
            if ($this->has_children && 0 === $depth) {
                $atts['href']          = "#menu-item-dropdown-{$item->ID}-submenu";
